...
def main():
  outfile = open("./HTNewErrors375.txt",'w')
  c1 = Print("./HTNewErrors375.pdf")
  text = ""
...
# ],[40.352,158.567,119.04,385.241,3.756,204.618,766.599,1941.,694.178,117.644,]),
  ...
  for key,values in sums.iteritems():
    ...
    for Dir in values[0]:
      print Dir
      nomList.append(GetSumHist(File = [".//HTRun2011AB.root"], Directories = [Dir], Hist = histList[0], Col = r.kBlack, Norm = None, LegendText = ""))
      denomList.append(GetSumHist(File = ["./HTRun2011AB.root"], Directories = [Dir], Hist = histList[1], Col = r.kRed,   Norm = None, LegendText = ""))
  ...
  text = ""
  print "WE SHOULD BE STARTING HERE!!!"
  print CumuNomList[0].GetNbinsX()
